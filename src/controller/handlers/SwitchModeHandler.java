...
public class SwitchModeHandler implements EventHandler<ActionEvent>{
     ...
     */
    public SwitchModeHandler(BuildController buildController, PlayController playController, HorizontalDirection direction) {
        this.buildController = buildController;
        this.playController = playController;
        this.direction = direction;
        this.from = buildController.getRoot();
        this.to = playController.getRoot();
    ...
    public void handle(ActionEvent event) {
        if (direction == RIGHT) {
            ...
            playController.setDoNothing(false);
